...
This site is mainly a blog, and it runs in two threads. One is about **machines that learn**: from [why ML’s notion of uncertainty is conceptually broken](/blog/2026/uncertainty-decomposition/) to the occasional wander into [minds and machines](/blog/2026/the-self-before-memory/). The other is about **systems that last**: [the debts you consciously carry](/blog/2025/mvp-manage-debt-and-iterate-fast/) while building a product, and [the invisible work that nobody rewards](/blog/2026/we-reward-the-fix-not-the-prevention/) but everything depends on.
...
If you’d like to keep up to date, subscribe to the newsletter below.
