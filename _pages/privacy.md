...
This website is operated by Christian Henning and is a personal, non-commercial blog. I process personal data sparingly and in accordance with the Swiss Federal Act on Data Protection (FADP).
...
If you subscribe, your email address is processed and stored by [Loops](https://loops.so/) to deliver the newsletter; this data is processed in the United States. Subscription uses double opt-in, so you must confirm via email, and you can unsubscribe at any time via the link in every email. See Loops' [Privacy Policy](https://loops.so/privacy).
