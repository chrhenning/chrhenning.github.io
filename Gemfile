...
group :al_folio_plugins do
    ...
    # al_ext_posts is deliberately omitted: it always live-fetches and ignores the
    # curated title/description in external_sources. _plugins/external-posts.rb is
    # used instead. Do not reinstate it when merging upstream.
